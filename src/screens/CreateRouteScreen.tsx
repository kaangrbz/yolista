        ...
        <SafeAreaView style={[styles.container, { backgroundColor: '#fff' }]}>
            ...
            <ScrollView style={[styles.container]}>
                <View style={styles.form}>
                    ...
                    <View style={styles.inputContainer}>
                        <Text style={styles.sectionTitle}>Rota Durakları <Text style={{ color: 'red' }}>*</Text></Text>
                        <Text style={{ color: '#666', fontSize: 12, marginBottom: 8 }}> (En fazla 10 durak ekleyebilirsiniz)</Text>
                            ...
                            <View key={point.client_id} style={styles.routeItem}>
                                ...
                                <View style={styles.inputGroup}>
                                    ...
                                    <TextInput
                                        style={styles.input}
                                        value={point.title}
                                        onChangeText={(text) => updateRoutePoint(point.client_id, 'title', text)}
                                ...
                                <View style={styles.inputGroup}>
                                    ...
                                    <TextInput
                                        ...
                                        onChangeText={(text) => updateRoutePoint(point.client_id, 'description', text)}
